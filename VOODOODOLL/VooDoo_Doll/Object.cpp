	...
	_TCHAR* pwstrTextureName, CTexture** ppTexture, CGameObject* pParent, FILE* pInFile, CShader* pShader, int choose, int whatTexture)
{
	...
	if (!strcmp(pstrTextureName, "null"))
	{
		...
		if (1 == whatTexture)//albedo
		{
			...
			case 4:
				//strcpy_s(pstrTextureName, sizeof(pstrTextureName), "Voodoo3Albed");//부두4 펜싱칼든애
				break;
			case 5:
		...
		else if (2 == whatTexture)//normal
		{
			...
			case 3:
				...
				break;
			case 4:
				//strcpy_s(pstrTextureName, sizeof(pstrTextureName), "Voodoo3Norma");//부두4 펜싱칼든애
				break;
		...
		else if (3 == whatTexture)//metallic 
		{
			...
			case 4:
				//strcpy_s(pstrTextureName, sizeof(pstrTextureName), "Voodoo3Metal");//부두4 펜싱칼든애
				break;
			case 5:
		...
		else if (4 == whatTexture)//emission
		{
			...
			case 3:
				...
				break;
			case 4:
				//strcpy_s(pstrTextureName, sizeof(pstrTextureName), "Voodoo3Emiss");//부두4 펜싱칼든애
				break;
