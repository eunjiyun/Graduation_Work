...
void CGameFramework::changePlayerForm(CPlayer** sceneOldPlayer, CPlayer** oldPlayer, CTerrainPlayer* newPlayer, CTerrainPlayer* newPlayer2, CTerrainPlayer* newPlayer3)//¹ÞÀ» ÇÃ·¹ÀÌ¾î, ÇÒ´çÇÒ ÇÃ·¹ÀÌ¾î
{
	int choosePlayer = 0;
