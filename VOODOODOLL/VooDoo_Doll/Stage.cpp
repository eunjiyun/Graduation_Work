...
void CStage::BuildObjects(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList)
{
	...
	m_ppHierarchicalGameObjects[0] = new CZebraObject(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature, pZebraModel, 3, 1);//손에 칼
	...
	m_ppHierarchicalGameObjects[1] = new CZebraObject(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature, pZebraModel2, 3, 2);//뼈다귀 다리
	...
	m_ppHierarchicalGameObjects[1]->m_pSkinnedAnimationController->SetTrackEnable(2, true);
	...
	CLoadedModelInfo* pZebraModel3 = CGameObject::LoadGeometryAndAnimationFromFile(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature, "Model/Voodoo31.bin", NULL, 3);//자폭하게
	m_ppHierarchicalGameObjects[2] = new CZebraObject(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature, pZebraModel3, 2, 3);//귀신
	...
	m_ppHierarchicalGameObjects[3] = new CZebraObject(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature, pZebraModel4, 5, 4);//손에 바늘
	...
	m_ppHierarchicalGameObjects[3]->m_pSkinnedAnimationController->SetTrackEnable(4, true);//area attack? 화재발생
	...
	m_ppHierarchicalGameObjects[4] = new CZebraObject(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature, pZebraModel5, 3, 5);//마법사
	...
	m_ppHierarchicalGameObjects[4]->m_pSkinnedAnimationController->SetTrackEnable(1, false);
	m_ppHierarchicalGameObjects[4]->m_pSkinnedAnimationController->SetTrackEnable(2, true);
	...
	m_ppHierarchicalGameObjects[5]->m_pSkinnedAnimationController->SetTrackEnable(1, false);
	m_ppHierarchicalGameObjects[5]->m_pSkinnedAnimationController->SetTrackEnable(2, true);
