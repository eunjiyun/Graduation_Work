...
{
	return(CShader::CompileShaderFromFile(L"Shaders.hlsl", "VSNewTextured", "vs_5_1", ppd3dShaderBlob));
}

D3D12_SHADER_BYTECODE CTexturedShader::CreatePixelShader(ID3DBlob** ppd3dShaderBlob)
{
	return(CShader::CompileShaderFromFile(L"Shaders.hlsl", "PSNewTextured", "ps_5_1", ppd3dShaderBlob));
}
