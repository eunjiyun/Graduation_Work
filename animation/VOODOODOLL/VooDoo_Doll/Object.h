...
public:
	...
	void SetCbvGPUDescriptorHandlePtr(UINT64 nCbvGPUDescriptorHandlePtr) { m_d3dCbvGPUDescriptorHandle.ptr = nCbvGPUDescriptorHandlePtr; }//¿©±â
	//
	...
	//23.02.02
	virtual void UpdateShaderVariables(ID3D12GraphicsCommandList* pd3dCommandList, bool choose);
	//
